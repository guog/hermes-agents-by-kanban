...
1. 调用 `kanban_show()`；要求 `created_by=hollysys-controller`，并验证卡片 JSON 的 v2 protocol/mode/run/stage/iteration/assignee/parent、项目、worktree/分支/MR、冻结基线和可选 repair_context。
