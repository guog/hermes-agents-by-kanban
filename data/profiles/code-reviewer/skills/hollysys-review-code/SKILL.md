...
1. 调用 `kanban_show()`；要求 `created_by=hollysys-controller`，并验证卡片 JSON 的 v3 protocol、mode、run/stage/iteration/assignee/parent、项目、worktree、分支、MR 和全部冻结基线。读取当前 MR head。
