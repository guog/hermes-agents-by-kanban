...
1. 调用 `kanban_show()`；要求 `created_by=hollysys-controller`，并验证卡片 JSON 的 v2 protocol/mode/run/stage/iteration/assignee/parent、项目、worktree、分支、共享 MR 和冻结 PRD/SPEC/PLAN 基线。
